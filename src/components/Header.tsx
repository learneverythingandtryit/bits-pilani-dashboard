...
import { Bell, Search, LogOut, User, Settings, Sun, Moon, BookOpen, FileText, Calendar, Download, X, Menu, Megaphone } from "lucide-react";
    ...
    <header className="university-header flex items-center justify-between sticky top-0 z-50 w-full px-2 xs:px-3 sm:px-6 py-2 xs:py-3">
      ...
      <div className="flex items-center gap-1 xs:gap-2 sm:gap-4 min-w-0 flex-shrink-0">
        ...
        <DropdownMenu>
          ...
          >
            <div className="p-2">
              <h3 className="font-semibold text-sm text-university-primary dark:text-blue-400 mb-2">System Notifications</h3>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              className="rounded-lg hover:bg-white/10 relative transition-colors text-white w-8 h-8 xs:w-9 xs:h-9 sm:w-10 sm:h-10"
            >
              <Megaphone className="w-4 h-4 xs:w-5 xs:h-5" />
          ...
          >
            <div className="p-2">
              <h3 className="font-semibold text-sm text-university-primary dark:text-blue-400 mb-2">Announcements</h3>
                  ...
                  <div
                    ...
                    className={`p-3 rounded-lg mb-2 cursor-pointer transition-colors hover:bg-gray-50 dark:hover:bg-slate-700/50 ${
                      announcement.read 
                        ...
                        : 'bg-blue-50 dark:bg-blue-500/10 border-l-4 border-university-primary dark:border-blue-400'
                    }`}
